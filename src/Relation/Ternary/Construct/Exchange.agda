...
module DownIntuitive {{r₂-intuitive : IsIdempotent U r₂}} where

  instance exchange-intuitive-down : ∀ {P} → IsIdempotent (Down P) exchange-rel
  IsIdempotent.∙-idem exchange-intuitive-down (↓ _) = ex sub-ε sub-ε ∙-idˡ (∙-idem tt)
